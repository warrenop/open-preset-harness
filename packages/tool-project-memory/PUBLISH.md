...
```sh
dsh plugin --profile web add "github:warrenop/open-preset-harness#v0.3.1&path:packages/tool-project-memory"
```

Latest tag: [v0.3.1](https://github.com/warrenop/open-preset-harness/releases/tag/v0.3.1) · [v0.3.0](https://github.com/warrenop/open-preset-harness/releases/tag/v0.3.0) · [v0.2.0](https://github.com/warrenop/open-preset-harness/releases/tag/v0.2.0)
