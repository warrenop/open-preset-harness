...
```sh
dsh plugin --profile web add "github:warrenop/open-preset-harness#v0.6.0&path:packages/tool-project-memory"
```

Latest tag: [v0.6.0](https://github.com/warrenop/open-preset-harness/releases/tag/v0.6.0) · [v0.5.0](https://github.com/warrenop/open-preset-harness/releases/tag/v0.5.0) · [v0.3.0](https://github.com/warrenop/open-preset-harness/releases/tag/v0.3.0)
